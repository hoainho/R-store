            ...
            <div className="store">
                    ...
                    <div className="row store-main">
                        ...
                        <div className="col-xs-10 col-sm-10 col-md-10 col-lg-10 store-main--container">
                                ...
                                <div className="store-main--container_menu-options">
                                    <ul className="nav store-main--container_menu-options--list" >
                                        <li id="tab-item " className="nav-item store-main--container_menu-options--list_item">
                                          <a href="#tab_multi" className="nav-link active  store-main--container_menu-options--list_link store-main--container_menu-options--list_multi " id="nav-multi" role="tab" aria-controls="nav-multi" aria-selected="true" data-toggle="tab" id="tab-link"></a>
                                           
                                        </li>
                                        <li id="tab-item " className="nav-item store-main--container_menu-options--list_item">
                                          <a href="#tab_single" className="nav-link store-main--container_menu-options--list_link store-main--container_menu-options--list_single"id="nav-single" role="tab" aria-controls="nav-single" aria-selected="true" data-toggle="tab" id="tab-link" ></a>
                                        </li>
                            ...
                            <div id="nav-tabContent" className="tab-content store-main--container_storage">
                                <div id="tab_multi" role="tabpanel" aria-labelledby="nav-multi" className="store-main--container_content tab-pane fade ">
                                ...
                                <div className="store-main--container_content tab-pane fade show active">
