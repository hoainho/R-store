                    ...
                    <div className="product-tab--container_tittle-category  product-tab--container_tittle-category-KB">
                            <ul  role="tablist" id="nav-tab" className="product-tab--container_tittle-category__list nav nav-tabs">
                                ...
                                <li  id="tab-item " className="product-tab--container_tittle-category__item active-tab--item nav-item">
                                    <a href="#tab_KBasus" id="nav-KBasus" role="tab" aria-controls="nav-KBasus" aria-selected="true" data-toggle="tab" id="tab-link" className="product-tab--container_tittle-category__link  nav-link active">Asus</a>
                                </li>
                                
                                <li  id="tab-item " className="product-tab--container_tittle-category__item active-tab--item nav-item">
                                    <a href="#tab_KBacer" id="nav-KBacer" role="tab" aria-controls="nav-KBacer" aria-selected="true" data-toggle="tab" id="tab-link" className="product-tab--container_tittle-category__link  nav-link ">Acer</a>
                                </li>
                                
                                <li  id="tab-item " className="product-tab--container_tittle-category__item active-tab--item nav-item">
                                    <a href="#tab_KBlogitech" id="nav-KBlogitech" role="tab" aria-controls="nav-KBlogitech" aria-selected="true" data-toggle="tab" id="tab-link" className="product-tab--container_tittle-category__link  nav-link ">Logitech</a>
                                </li>
                                
                                <li  id="tab-item " className="product-tab--container_tittle-category__item active-tab--item nav-item">
                                    <a href="#tab_KBsony" id="nav-KBsony" role="tab" aria-controls="nav-KBsony" aria-selected="true" data-toggle="tab" id="tab-link" className="product-tab--container_tittle-category__link  nav-link ">Sony</a>
                                </li>
                            </ul>
                        </div>
