...
export default class CartMini extends Component {
    render(){
        return(
            <div>
                {/* <!-- Modal --> */}
                <div className="modal fade navbar-content--header_main__features___control-cart--storage" id="exampleModalScrollable"  role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
                    <div className="modal-dialog modal-dialog-scrollable" role="document">
                        ...
                        <div className="modal-footer navbar-content--header_main__features___control-cart--storage_container__control">
                            ...
                            <button  className="product-tab--container_content__category___product-button--card left-0">Thanh Toán</button>
