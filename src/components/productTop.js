        ...
        return (
            // <!-- PRODUCT-TAB  -->
                <div className="product-tab">
                    <div classNames={"product-tab--container product-tab--container_hero"}>
                        <div className="product-tab--container_tittle">
                            <ul  role="tablist"  classNames= {'product-tab--container_tittle__list',' nav', 'nav-tabs'}>
                                <li   id="tab-item " className="product-tab--container_tittle__item active-tab--item nav-item">
                                    <a href="#tab_new-arrival" id="nav-new-arrival" role="tab" aria-controls="nav-new-arrival" aria-selected="true" data-toggle="pill" id="tab-link" className="product-tab--container_tittle__link  nav-link active">Hàng mới về</a>
                                </li>
                                
                                <li   id="tab-item "  className="product-tab--container_tittle__item active-tab--item nav-item">
                                    <a href="#tab_best-seller" id="nav-best-seller" role="tab" aria-controls="nav-best-seller" aria-selected="true" data-toggle="tab" id="tab-link" className="product-tab--container_tittle__link  nav-link ">Bán chạy</a>
                                </li>
                                
                                <li  id="tab-item " className="product-tab--container_tittle__item active-tab--item nav-item">
                                    <a href="#tab_featured" id="nav-featured" role="tab" aria-controls="nav-featured" aria-selected="true" data-toggle="tab"id="tab-link" className="product-tab--container_tittle__link  nav-link ">Đề xuất</a>
                                </li>
                                
                                <li  id="tab-item " className="product-tab--container_tittle__item active-tab--item nav-item">
                                    <a href="#tab_hot-sell" id="nav-hot-sell" role="tab" aria-controls="nav-hot-sell" aria-selected="true" data-toggle="tab" id="tab-link" className="product-tab--container_tittle__link  nav-link ">Giảm giá</a>
                                </li>
                            </ul>
                        </div>
                        <div id="nav-tabContent" className="product-tab--container_content tab-content ">
                            
                            <Slider { ...settings } id="tab_new-arrival"   role="tabpanel" aria-labelledby="nav-new-arrival"   className=" product-tab--container_content__box tab-pane fade show active">
                            ...
                            <Slider { ...settings } id="tab_best-seller"   role="tabpanel" aria-labelledby="nav-best-seller"   className=" product-tab--container_content__box tab-pane fade ">
                                <div className="product-tab--container_content__box___product">
                                    <img className="product-tab--container_content__box___product-pic product-tab--container_content__box___product-pic--B" src="/img/mouse1A.png" alt=""/>
                                    <img className="product-tab--container_content__box___product-pic product-tab--container_content__box___product-pic--A" src="/img/mouse1B.png" alt=""/>
                                    <span className="product-tab--container_content__box___product-details">
                            ...
                            <Slider { ...settings } id="tab_featured"      role="tabpanel" aria-labelledby="nav-featured"      className=" product-tab--container_content__box tab-pane fade  ">
                                <div className="product-tab--container_content__box___product">
                                    <img className="product-tab--container_content__box___product-pic product-tab--container_content__box___product-pic--B" src="/img/keyboard1A.png" alt="keyboard" />
                                    <img className="product-tab--container_content__box___product-pic product-tab--container_content__box___product-pic--A" src="/img/keyboard1B.png" alt="keyboard" />
                                    <span className="product-tab--container_content__box___product-details"><a className="sm_open product-tab--container_content__box___product-details--link" data-modal="exampleAdvanced" data-effect="pushup" data-icons="is_right">
                            ...
                            <Slider { ...settings } id="tab_hot-sell"      role="tabpanel" aria-labelledby="nav-hot-sell"      className=" product-tab--container_content__box tab-pane fade  ">
                                <div className="product-tab--container_content__box___product">
                                    <img className="product-tab--container_content__box___product-pic product-tab--container_content__box___product-pic--B" src="/img/product-headphoneB.png" alt=""/>
                                    <img className="product-tab--container_content__box___product-pic product-tab--container_content__box___product-pic--A" src="/img/product-headphoneA.jpg" alt=""/>
                                    <span className="product-tab--container_content__box___product-details"><a className="sm_open product-tab--container_content__box___product-details--link" data-modal="exampleAdvanced" data-effect="pushup" data-icons="is_right">
